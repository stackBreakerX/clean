...
class PostProcessorModule @Inject constructor(
    ...
    private suspend fun checkExclusions(before: AppJunk): AppJunk? {
        ...
        val edgeCaseMap =
            mutableMapOf<ExpendablesFilterIdentifier, Collection<ExpendablesFilter.Match>>()
...
//        )
        ...
        if (after.itemCount > before.itemCount) {
            throw kotlin.IllegalStateException("Item count after exclusions can't be greater than before!")
        }
