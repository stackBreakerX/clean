...
//                            kotlin.IllegalStateException("trimCache failed, single:${junk.identifier}")
//                }
//            }
//        } catch (e: Exception) {
//            log(TAG, ERROR) { "Trimming caches failed: ${e.asLog()}" }
//            trimCandidates.forEach {
//                failedTargets[it.identifier] = kotlin.IllegalStateException("trimCache failed, multi:${it.identifier}")
//            }
//        }
//
//        return InaccDelResult(
