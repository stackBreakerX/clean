...
//                throw kotlin.UnsupportedOperationException("ACS based deletion is not support for other users ($target)")
//            }
//
...
//                failed[target] set kotlin.IllegalStateException("$target is not in package repo")
//                continue
//            }
//
...
//                        updateProgressPrimary(R.string.general_cancel_action)
