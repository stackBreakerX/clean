...
import com.ohz.clean.common.ContentItem
import com.ohz.clean.common.DeviceStorage
import com.ohz.clean.common.FileForensics
import com.ohz.clean.common.InventorySetupModule
import com.ohz.clean.common.Marker
import com.ohz.clean.common.MediaCategory
import com.ohz.clean.common.OwnerInfo
import com.ohz.clean.common.SystemCategory
import com.ohz.clean.common.UsageStatsSetupModule
...
import com.ohz.clean.common.walkContentItem
...
import com.ohz.clean.ui.view.progress.increaseProgress
...
class StorageScanner @Inject constructor(
    ...
    suspend fun scan(storage: DeviceStorage): Collection<ContentCategory> {
        ...
        updateProgressSecondary(R.string.general_progress_loading)
