...
import com.ohz.clean.common.dataarea.restrictedCharset
...
open class NestedPackageMatcher(
    ...
    private val dynamicMarkers: MutableCollection<Marker> = kotlin.collections.HashSet()
    private val markerMapByPkg: MutableMap<Pkg.Id, MutableCollection<Marker>> =
    ...
    override suspend fun getMarkerForPkg(pkgId: Pkg.Id): Collection<Marker> {
        ...
        if (markers == null) {
            markers = kotlin.collections.HashSet()
